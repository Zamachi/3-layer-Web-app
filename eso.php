					...
					<div class="slajder">
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								...
								<img class="d-block w-100" src="https://cdn-products.eneba.com/resized-products/Mi_sqBy7uUq6m_YVANo9c_SYNqmjV-QVEhx9IS4VkD0_390x400_1x-0.jpeg" alt="First slide">
								</div>
								<div class="carousel-item">
								<img class="d-block w-100" src="https://esosslfiles-a.akamaihd.net/cms/2017/11/d1671a181906e49c71524583eed392a7.jpg" alt="Second slide">
								</div>
								<div class="carousel-item">
								<img class="d-block w-100" src="https://esosslfiles-a.akamaihd.net/cms/2020/03/0c7c2d8b08212dee44d380406588f097.jpg" alt="Third slide">
								</div>
							</div>
