					...
					<div class="slajder">
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								...
								<img class="d-block w-100" src="https://www.lineage2.com/images/desktop/about/about-classic.jpg" alt="First slide">
								</div>
								<div class="carousel-item">
								<img class="d-block w-100" src="https://static.filehorse.com/screenshots/games/lineage-2-screenshot-01.png" alt="Second slide">
								</div>
								<div class="carousel-item">
								<img class="d-block w-100" src="https://l2fight.com/images/fafurion_img_5_bg.jpg" alt="Third slide">
								</div>
							</div>
