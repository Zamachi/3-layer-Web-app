					...
					<div class="slajder">
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								...
								<img class="d-block w-100" src="https://cdn-products.eneba.com/resized-products/CJUAtejulvfKcmSW5ifPaLu3Ca6Ix_gzfGX8OG3h5L0_390x400_1x-0.jpeg" alt="First slide">
								</div>
								<div class="carousel-item">
								<img class="d-block w-100" src="https://sm.ign.com/t/ign_sr/screenshot/default/dia-switchpr-ingameui-4playerparty-tf-014-1534435120100_tnaz.1080.jpg" alt="Second slide">
								</div>
								<div class="carousel-item">
								<img class="d-block w-100" src="https://emulatorgaming.com/wp-content/uploads/2019/12/diablo3.png" alt="Third slide">
								</div>
							</div>
