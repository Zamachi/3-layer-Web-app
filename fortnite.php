					...
					<div class="slajder">
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								...
								<img class="d-block w-100" src="https://psmedia.playstation.com/is/image/psmedia/fortnite-chapter-2-listing-thumb-01-en-15oct19_1571214039851?$Icon$" alt="First slide">
								</div>
								<div class="carousel-item">
								<img class="d-block w-100" src="https://oradio.rs/files/uploads/2018/11/fortnite.jpg" alt="Second slide">
								</div>
								<div class="carousel-item">
								<img class="d-block w-100" src="https://i0.wp.com/pcpress.rs/wp-content/uploads/2019/10/fortnite-1.jpg?fit=800%2C450&ssl=1" alt="Third slide">
								</div>
							</div>
