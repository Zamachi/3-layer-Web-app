			...
			<div class="aligner">
				...
				<div id="registracionaForma">
					...
					<form id="forma" name="registracija" method="POST" action="confirm_login.php">
						...
						<div id="formTitle">	
							<label for="forma" style="margin: 0px auto; display: block; text-align: center;">Log into your account</label>
						</div>
						...
						<div class="formRow">
							<input  type="submit" style="display: block; margin: 0px auto;" value="Log In" id="dugmeZaSlanje" name="dugmeZaSlanje" form="forma">
						</div>
