	...
	<body>
		...
		<section id="teloStrane">
			...
			<div class="aligner">
				...
				<h1>This project was done for university purposes and by no means should be used as a finished and polished product.</h1>
				<h2>Credits go to:<br> Stefan Dimitrijević SII 2018/200497.</h2>
