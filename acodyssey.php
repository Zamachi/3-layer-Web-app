					...
					<div class="slajder">
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								...
								<img class="d-block w-100" src="https://www.itnetwork.rs/wp-content/uploads/2019/03/Assassins-Creed-Odyssey-02.jpg" alt="First slide">
								</div>
								<div class="carousel-item">
								<img class="d-block w-100" src="https://sm.ign.com/ign_sr/news/a/assassins-/assassins-creed-odysseys-dlc-announced-assassins-creed-iii-r_yc8h.jpg" alt="Second slide">
								</div>
								<div class="carousel-item">
								<img class="d-block w-100" src="https://i.insider.com/5bb7d85c93032c687b06c05b?width=1100&format=jpeg&auto=webp" alt="Third slide">
								</div>
							</div>
