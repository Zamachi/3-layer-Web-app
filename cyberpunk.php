					...
					<div class="slajder">
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								...
								<img class="d-block w-100" src="https://cdn.mos.cms.futurecdn.net/aG3vxVoPkYMnqRAcWtXphE.jpg" alt="First slide">
								</div>
								<div class="carousel-item">
								<img class="d-block w-100" src="https://www.benchmark.rs/assets/img/news/big_thumb/6d8cfad34a28381de3d06c800f635c66.jpg" alt="Second slide">
								</div>
								<div class="carousel-item">
								<img class="d-block w-100" src="https://static.mondo.rs/Picture/816969/jpeg/Cyberpunk-2077-4.jpg" alt="Third slide">
								</div>
							</div>
