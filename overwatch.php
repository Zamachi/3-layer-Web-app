					...
					<div class="slajder">
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								...
								<img class="d-block w-100" src="https://klanrur.co.rs/wp-content/uploads/2018/11/overwatch.jpg" alt="First slide">
								</div>
								<div class="carousel-item">
								<img class="d-block w-100" src="https://cdn-products.eneba.com/resized-products/0n2t-IjvC5nWMsPBaHDWWyICFdnBRdFTTm3MQHdrnQY_390x400_1x-0.jpeg" alt="Second slide">
								</div>
								<div class="carousel-item">
								<img class="d-block w-100" src="https://cdn-products.eneba.com/resized-products/tIjfpBJxp3s_qiKModyQLFnaTInRuOGWoU9hty2MiDY_390x400_1x-0.jpeg" alt="Third slide">
								</div>
							</div>
